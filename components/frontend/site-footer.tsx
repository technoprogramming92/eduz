...
export default function SiteFooter() {
  return (
    <footer className="w-full bg-[#121616] text-white">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <p>services@ignitax.com</p>
              <p>+91 704 391 2358</p>
              <p>
                Siddhivinayak Arcade, A-427, beside Cancer society, Gupta Nagar,
                Vasna, Ahmedabad, Gujarat 380051
              </p>
            </div>
          </div>
